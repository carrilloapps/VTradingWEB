...
import { Box, Container, Typography, Grid, useTheme, alpha, Paper, Fade } from '@mui/material';
        ...
        <Container maxWidth="lg">
          <Fade in timeout={1000}>
            <Box sx={{ textAlign: 'center', mb: 10 }}>
              ...
              >
                VTrading nació de la necesidad de transparencia en un mercado fragmentado.
                Construimos puentes tecnológicos para que cada venezolano tenga datos precisos en la
                palma de su mano.
              </Typography>
            </Box>
          </Fade>
          ...
          <Grid container spacing={8} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 3, lineHeight: 1.8 }}>
                VTrading no comenzó en una oficina corporativa, sino en una terminal de trading. La
                frustración por la falta de datos centralizados y precisos en Venezuela nos llevó a
                crear nuestra propia solución.
              </Typography>
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4, lineHeight: 1.8 }}>
                Hoy, lo que empezó como un script personal se ha convertido en una plataforma
                robusta que sirve a miles de usuarios diariamente, manteniendo nuestro compromiso
                original con la integridad de los datos.
              </Typography>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                <Box
                  sx={{ bgcolor: 'background.paper', p: 6, borderRadius: 9.5, textAlign: 'center' }}
                >
                  <Typography
                    variant="h1"
                    fontWeight="900"
                    sx={{ color: 'primary.main', mb: 1, fontSize: '5rem' }}
                  >
                    +10k
                  </Typography>

                ...
                <Box sx={{ position: 'relative' }}>
                  ...
                  >
                    ...
                    <Box sx={{ p: 3, position: 'relative', height: '100%' }}>
                      {loading && (
                        <Box sx={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: alpha(theme.palette.background.default, 0.7), zIndex: 10 }}>
                      ...
                      <Paper sx={{ p: 2, borderRadius: 4, mb: 3, bgcolor: alpha(theme.palette.primary.main, 0.05) }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                          ...
                          <Typography variant="caption" sx={{ color: 'trendUp', fontWeight: 800 }}>
                            {marketData?.rates?.rates?.find((r: any) => r.currency === 'USD')?.change === 'up' ? '+' : '-'}{marketData?.rates?.rates?.find((r: any) => r.currency === 'USD') ? '0.12%' : '...'}
                          </Typography>
                        </Box>
                        ...
                        {marketData?.bvc?.quotes?.slice(0, 3).map((item: any) => (
                          ...
                          <>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1.5 }}>
                              <Typography variant="caption" fontWeight="700">Mercantil A</Typography>
                              <Typography variant="caption" sx={{ color: 'trendUp', fontWeight: 800 }}>34,50 ▲</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1.5 }}>
                              <Typography variant="caption" fontWeight="700">Bco. Provincial</Typography>
                              <Typography variant="caption" sx={{ color: 'error.main', fontWeight: 800 }}>12,20 ▼</Typography>
                            </Box>
                          </>
                        )}
                      </Paper>

              ...
              <Fade in timeout={1000}>
                <Box>
                  ...
                  >
                    ...
                    >
                      <Image src={flagVe} alt="Venezuela" fill style={{ objectFit: 'cover' }} />
                    </Box>
                  </Typography>
                  ...
                  >
                    ¿Interesado en nuestras licencias de datos, integraciones API o soporte
                    empresarial? Nuestro equipo especializado está listo para brindarte la mejor
                    solución.
                  </Typography>
                  ...
                  <Stack spacing={4}>
                    {[
                      {
                        icon: EmailIcon,
                        title: 'Ventas y Licencias',
                        detail: 'ventas@vtrading.app',
                      },
                      {
                        icon: BusinessIcon,
                        title: 'Soporte Corporativo',
                        detail: 'soporte@vtrading.app',
                      },
                      {
                        icon: PhoneIcon,
                        title: 'Atención Telefónica',
                        detail: '+58 (212) 555-0199',
                      },
                      {
                        icon: LocationOnIcon,
                        ...
                        <FormControlLabel
                          ...
                          label={
                            <Typography variant="body2" color="text.secondary">
                              ...
                              <Link href="/privacidad" passHref legacyBehavior>

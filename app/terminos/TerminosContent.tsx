            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <section>
                ...
                >
                  ...
                  <Typography component="div" variant="body2" sx={{ lineHeight: 1.6 }}>
                    VTrading es <strong>EXCLUSIVAMENTE</strong> una plataforma de monitoreo,
                    análisis e inteligencia de datos financieros.
                    <br />
                    <br />
                    ...
                    En ningún momento captamos fondos, custodiamos activos de usuarios ni procesamos
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  Al acceder y utilizar VTrading (Web o App Móvil), usted acepta cumplir y estar
                  legalmente obligado por los presentes Términos y Condiciones. Si no está de
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  Para el correcto funcionamiento de la aplicación móvil VTrading, el usuario acepta
                  otorgar los siguientes permisos necesarios:
                </Typography>
                <TableContainer
                  component={Paper}
                  variant="outlined"
                  ...
                  <Table size="small">
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          Comunicación con la API y verificación de conectividad.
                        </TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          Identificador para analíticas y publicidad (en versión gratuita).
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  VTrading ofrece acceso a datos financieros y herramientas de análisis. El acceso
                  se rige por planes de suscripción y límites de uso (RPM).
                </Typography>
                <Alert severity="info" variant="outlined" sx={{ mb: 2 }}>
                  El usuario se compromete a no exceder los límites establecidos en su plan. El uso
                  no autorizado o excesivo de la API puede resultar en la suspensión temporal o
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  Los usuarios de la versión gratuita aceptan la visualización de anuncios
                  publicitarios proporcionados por terceros (Google AdMob). Estos anuncios son
                  necesarios para mantener la gratuidad del servicio básico.
                </Typography>
              </section>
              ...
              <section>
                ...
                >
                  <Typography variant="body1" color="text.secondary" paragraph>
                    La información proporcionada por VTrading es únicamente con fines informativos y
                    educativos.
                  </Typography>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    VTrading no se hace responsable de las decisiones financieras tomadas por el
                    usuario basadas en la información de la plataforma. El trading conlleva riesgos
                    significativos y usted debe consultar con un asesor financiero certificado antes
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  Todos los derechos, títulos e intereses sobre la plataforma, incluyendo pero no
                  limitado a software, textos, gráficos, logotipos y marcas, son propiedad exclusiva
                  de VTrading o sus licenciantes y están protegidos por las leyes de propiedad
              ...
              <section>
                ...
                <Typography variant="body1" color="text.secondary">
                  En la medida máxima permitida por la ley, VTrading no será responsable de daños
                  indirectos, incidentales, especiales, consecuentes o punitivos, ni de ninguna
                  pérdida de beneficios o ingresos, ya sea incurrida directa o indirectamente, o
                  cualquier pérdida de datos, uso, fondo de comercio u otras pérdidas intangibles.
                </Typography>
              </section>
            </Box>
          </Paper>

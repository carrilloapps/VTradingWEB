...
const socialLinks = [
  { icon: <XIcon fontSize="small" />, href: 'https://x.com/VTradingAPP', label: 'X (Twitter)' },
  {
          ...
          <Grid size={{ xs: 12, md: 4, lg: 5 }}>
            <Box sx={{ maxWidth: 360 }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4, lineHeight: 1.7 }}>
                Democratizando el acceso a datos financieros en Venezuela. Infraestructura robusta
                para un mercado transparente y eficiente.
              </Typography>

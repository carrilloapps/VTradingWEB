          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', mt: -0.8 }}>
            ...
            <Box sx={{ pr: 1.5, borderRight: '1px solid rgba(255,255,255,0.2)', mr: 1.5 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'baseline' }}>
                <Typography
                  variant="h6"
                  sx={{ fontWeight: 700, lineHeight: 1, fontSize: '1rem', color: '#FFFFFF' }}
                >
                  {formatPrice(data.general.price)}
                </Typography>
                <Typography
                  variant="caption"
                  sx={{ color: 'rgba(255, 255, 255, 0.7)', ml: 0.5, fontSize: '0.65rem' }}
                >
                  Bs
                </Typography>
              </Box>
              <Typography
                variant="caption"
                sx={{
                  color: getTrendColor(data.general.change),
                  fontWeight: 700,
                  fontSize: '0.7rem',
                }}
              >
            ...
            <Box sx={{ pr: 1.5, borderRight: '1px solid rgba(255,255,255,0.2)', mr: 1.5 }}>
              ...
              <Typography
                variant="caption"
                sx={{ color: getTrendColor(data.buy.change), fontWeight: 700, fontSize: '0.7rem' }}
              >
                {data.buy.change}
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography
                variant="caption"
                sx={{ color: getTrendColor(data.sell.change), fontWeight: 700, fontSize: '0.7rem' }}
              >
                {data.sell.change}
              </Typography>
            </Box>
